...
RSpec.describe UsersController do
  ...
  context 'when authenticated' do
    ...
    describe 'GET leagues' do
      before(:each) do
        get :index, params: { id: @league_id }, format: :json
      end
    ...
    describe 'GET games' do
      before(:each) do
        get :index, params: { id: @game_id }, format: :json
      end
    ...
    describe 'POST leagues' do
      before(:each) do
        post :leagues, params: { credentials: league_params }, format: :json
      end
    ...
    describe 'POST games' do
      before(:each) do
        post :games, params: { credentials: game_params }, format: :json
      end
